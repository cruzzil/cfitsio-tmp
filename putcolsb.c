...
int ffpprsb( fitsfile *fptr,  /* I - FITS file pointer                      */
            ...
            const signed char *array, /* I - array of values that are written     */
...
int ffp2dsb(fitsfile *fptr,   /* I - FITS file pointer                    */
           ...
           const signed char *array, /* I - array to be written                 */
           int  *status)     /* IO - error status                         */
/*
...
int ffpclsb( fitsfile *fptr,  /* I - FITS file pointer                      */
            ...
            LONGLONG  firstelem, /* I - first vector element to write (1 = 1st) */
            LONGLONG  nelem,     /* I - number of values to write               */
            const signed char *array, /* I - array of values to write             */
            int  *status)    /* IO - error status                           */
/*
