...
int ffpprd( fitsfile *fptr,  /* I - FITS file pointer                       */
            ...
            const double *array,   /* I - array of values that are written        */
...
int ffp2dd(fitsfile *fptr,   /* I - FITS file pointer                     */
           ...
           const double *array,    /* I - array to be written                   */
           int  *status)     /* IO - error status                         */
/*
...
int ffpcld( fitsfile *fptr,  /* I - FITS file pointer                       */
            ...
            LONGLONG  firstelem, /* I - first vector element to write (1 = 1st) */
            LONGLONG  nelem,     /* I - number of values to write               */
            const double *array,   /* I - array of values to write                */
            int  *status)    /* IO - error status                           */
/*
...
int ffpcnd( fitsfile *fptr,  /* I - FITS file pointer                       */
            ...
            LONGLONG  nelem,     /* I - number of values to write               */
            const double *array,   /* I - array of values to write                */
            const double nulvalue, /* I - value used to flag undefined pixels     */
            int  *status)    /* IO - error status                           */
/*
