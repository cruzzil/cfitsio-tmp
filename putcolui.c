...
int ffpprui(fitsfile *fptr,  /* I - FITS file pointer                       */
   ...
   const unsigned short *array,    /* I - array of values that are written        */
...
int ffp2dui(fitsfile *fptr,   /* I - FITS file pointer                     */
  ...
  const unsigned short *array,     /* I - array to be written                   */
           int  *status)     /* IO - error status                         */
/*
...
int ffpclui( fitsfile *fptr,  /* I - FITS file pointer                       */
            ...
            LONGLONG  firstelem, /* I - first vector element to write (1 = 1st) */
            LONGLONG  nelem,     /* I - number of values to write               */
   const unsigned short *array,    /* I - array of values to write                */
            int  *status)    /* IO - error status                           */
/*
